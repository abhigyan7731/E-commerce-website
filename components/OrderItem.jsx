                            ...
                            <div key={index} className="flex items-center gap-4">
                                <div className="w-20 aspect-square bg-slate-100 flex items-center justify-center rounded-md">
                                    {item.product.images && item.product.images[0] && item.product.images[0].trim() !== "" ? (
                                        ...
                                        <div className="h-14 w-14 bg-gray-200 flex items-center justify-center text-xs text-gray-500 rounded">No Image</div>
                                    )}
                                </div>
                                <div className="flex flex-col justify-center text-sm">
                                    ...
                                    <div>
                                        {(() => {
                                            const existingRating = ratings && ratings.find(rating => rating && order.id === rating.orderId && item.product.id === rating.productId);
