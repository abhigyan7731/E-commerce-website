        ...
        <div className="inline-flex h-full flex-col gap-5 border-r border-slate-200 sm:min-w-60">
            <div className="flex flex-col gap-3 justify-center items-center pt-8 max-sm:hidden">
                {storeInfo?.logo ? (
                    ...
                    <div className="w-14 h-14 rounded-full shadow-md bg-slate-200 text-slate-600 flex items-center justify-center text-lg font-semibold">
                        {(storeInfo?.name?.[0] || 'S').toUpperCase()}
                    </div>
                )}
